...
{
    public partial class frmBCSachTraHu : Form
    {
        ...
        private void LoadComboBox(ComboBox cbo, string tableName, string Ma, string TenMa)
        {
            try
            {
                ...
                cbo.DataSource = dt;
                cbo.ValueMember = Ma; // Giá trị thực tế
        ...
        private void btnInBC_Click(object sender, EventArgs e)
        {
            ...
            ReportDataSource reportDataSource = new ReportDataSource("DataSetSachTraHu", dt);
            reportViewer1.LocalReport.DataSources.Clear();
            reportViewer1.LocalReport.DataSources.Add(reportDataSource);
            reportViewer1.LocalReport.ReportEmbeddedResource = "QL_ThuVien.ReportsSystem.Reports.rptSachTraHu.rdlc";
